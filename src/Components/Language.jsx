...
function Language() {
  return (
    <div className="grid grid-cols-3 gap-1">
      <div className="hover:cursor-pointer hover:bg-stone-700 flex items-center gap-2 font-poppins border-2 rounded-lg inline-block justify-self-end self-center px-4 py-2">
