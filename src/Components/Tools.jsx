function Tools() {
  return (
    <div className="grid grid-cols-3 gap-2">
      <div className="hover:cursor-pointer hover:bg-stone-700 flex items-center gap-2 font-poppins border-2 border-yellow-300 rounded-lg inline-block justify-self-start self-center px-2 py-2">
        <p className="font-poppins font-bold text-sm">Chrome Dev Tools </p>
      </div>
