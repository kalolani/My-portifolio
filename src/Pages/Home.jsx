    ...
    <div className="w-full h-full z-30 phone:w-full">
      ...
      <div className="grid grid-cols-1fr-2fr gap-0 h-full w-full z-30 phone:grid-cols-1 laptop:grid-cols-1fr-2fr">
        ...
        <div className="self-center justify-self-start phone:ml-2 laptop:ml-10 phone:justify-self-end  laptop:justify-center">
          <h1 className="font-poppins text-white phone:text-lg phone:text-center laptop:text-start mt-4 tablet:text-2xl smlaptop:text-4xl laptop:text-[38px] tracking-wider uppercase font-bold phone:text-2xl ptab:text-3xl laptop:text-5xl">
          ...
          <p className="font-poppins text-white phone:px-2 mdphone:px-16 ptab:px-20 mtab:px-24 tablet:px-44 w-2/3 laptop:px-0  leading-loose phone:mt-2 laptop:mt-4 phone:w-full phone:text-center ptab:text-xl laptop:text-lg laptop:w-3/4 laptop:text-start">
